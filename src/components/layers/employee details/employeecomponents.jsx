...
<div>
            ...
            <h6 className="subtitle">{data.data.age}</h6>
            </div> 
            <div  class="input-card1">
            <h5 className="title">Place</h5>
            <h6 className="subtitle">{data.data.address.address}</h6>
            </div>
            <div  class="input-card1">
            <h5 className="title">State</h5>
            <h6 className="subtitle">{data.data.address.state}</h6>
            </div>
            {/* <div  class="input-card">
